  ...
  "use strict";
    ...
    jQuery(document).ready(function(){
        ...
        */
        ...
        --------------------------------------------------------- */
        $('.shop-details-large-img').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: false,
            fade: true,
            asNavFor: '.shop-details-small-img'
        });
        $('.shop-details-small-img').slick({
            slidesToShow: 4,
            slidesToScroll: 1,
            asNavFor: '.shop-details-large-img',
            dots: false,
            arrows: true,
            focusOnSelect: true,
        ...
        -------------------------------------------------------- */
        var $ltnGalleryActive = $('.gallery-active'),
            $ltnGalleryFilterMenu = $('.gallery-filter-menu');
        /*Filter*/
        ...
        /*----------------------
            Slider 11 active
        -----------------------*/
        $('.slider-11-active').on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
            var i = (currentSlide ? currentSlide : 0) + 1;
            $('.slider-11-pagination-count .count').text('0'+i);
            $('.slider-11-pagination-count .total').text('0' + slick.slideCount);

            $('.slider-11-slide-item-count .count').text('0'+i);
            $('.slider-11-slide-item-count .total').text('/0' + slick.slideCount);
            new WOW().init();
        }).slick({
            dots: false, /* slider left or right side pagination count with line */
            arrows: false, /* slider arrow  */
            appendDots: '.slider-11-pagination-count',
            infinite: true,
            autoplay: false,
            autoplaySpeed: 10000,
            speed: 500,
            asNavFor: '.slider-11-img-slide-arrow-active',
            slidesToShow: 1,
            slidesToScroll: 1,
            prevArrow: '<a class="slick-prev"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next"><i class="fas fa-arrow-right" alt="Arrow Icon"></i></a>',
        ...
        $('.slider-11-img-slide-arrow-active').slick({
            slidesToShow: 3,
            slidesToScroll: 1,
            initialSlide: 2,
            centerMode: false,
            centerPadding: '0px',
            asNavFor: '.slider-11-active',
        ...
        --------------------------------------------------------- */
        $('.product-slider-one-active').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            16-1. Product Slider One
        --------------------------------------------------------- */
        $('.product-slider-item-three-active').slick({
            arrows: true,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.product-slider-item-four-active').slick({
            arrows: true,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            16-2. Product Slider Item Four
        --------------------------------------------------------- */
        $('.product-slider-item-four-active-full-width').slick({
            arrows: true,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.related-product-slider-one-active').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.related-product-slider-two-active').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            ## Related Product Slider One
        --------------------------------------------------------- */
        $('.popular-product-widget-active').slick({
            arrows: false,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.tab-product-slider-one-active').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.small-product-slider-active').slick({
            arrows: false,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.testimonial-slider-2-active').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.testimonial-slider-3-active').slick({
            arrows: true,
            centerMode: true,
            centerPadding: '80px',
            dots: false,
        ...
        --------------------------------------------------------- */
        $('.testimonial-slider-5-active').slick({
            arrows: true,
            centerMode: false,
            centerPadding: '80px',
            dots: false,
        ...
        --------------------------------------------------------- */
        $('.testimonial-slider-6-active').slick({
            arrows: true,
            dots: false,
            centerMode: false,
            centerPadding: '80px',
        ...
        --------------------------------------------------------- */
        $('.upcoming-project-slider-1-active').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            # search-by-place-slider-1-active
        --------------------------------------------------------- */
        $('.search-by-place-slider-1-active').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        if($('.instafeed').length){
            ...
            $('.instafeed').on("DOMNodeInserted", function (e) {
                if (e.target.className == 'instagram_gallery') {
                    $('.instafeed-slider-2 .' + e.target.className).slick({
                        infinite: true,
                        slidesToShow: 3,
                        slidesToScroll: 1,
                        prevArrow: '<a class="slick-prev"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
                    ...
                    $('.instafeed-slider-1 .' + e.target.className).slick({
                        infinite: true,
                        slidesToShow: 5,
                        slidesToScroll: 1,
                        prevArrow: '<a class="slick-prev"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
        ...
        */
        ...
        -------------------------------------------------------- */
        var testimonial_quote_slider = $('.testimonial-slider-4-active');
        testimonial_quote_slider.slick({
            autoplay: true,
            autoplaySpeed: 3000,
            dots: false,
            arrows: true,
        ...
        testimonial_quote_slider.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
        ...
        $(document).on('click', '.testimonial-quote-menu li', function (e) {
            ...
            testimonial_quote_slider.slick('slickGoTo', elIndex);
